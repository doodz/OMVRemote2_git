package com.dev.doods.base.Plugins.LetsEncrypt;
...
public class LetsEncryptActivity extends AppCompatBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContoller.GetSettings(new CallbackImpl(this){
            ...
            public void onResponse(Call call, Response response) throws IOException, InterruptedException {
                ...
                res= response.GetResultObject(new TypeToken<LetsEncrypt>(){});
    ...
    private void ShowSettings(LetsEncrypt res)
    {
